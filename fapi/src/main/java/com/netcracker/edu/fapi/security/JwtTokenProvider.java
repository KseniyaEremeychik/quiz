...
public class JwtTokenProvider implements Serializable {
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser()
                .setSigningKey(JwtSecurityConsts.SIGNING_KEY)
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .claim(JwtSecurityConsts.AUTHORITIES_KEY, authorities)
                .signWith(SignatureAlgorithm.HS256, JwtSecurityConsts.SIGNING_KEY)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + JwtSecurityConsts.ACCESS_TOKEN_VALIDITY_SECONDS * 1000))
                .compact();
    }
